...
- 🛠️ **[devops-ci-cd-python-api](https://github.com/MarlonDeam/devops-ci-cd-python-api):** Pipeline de CI/CD para automação de testes e deploy de API Python.
- 🐧 **[qemu-kvm-alpine-infrastructure](https://github.com/MarlonDeam/qemu-kvm-alpine-infrastructure):** Ambiente de infraestrutura virtualizada leve utilizando QEMU/KVM e Alpine Linux.
...
**Sistemas, Banco de Dados & Infraestrutura**
...
- 🛡️ **Hackers do Bem:** Formação em Cibersegurança (Nivelamento & Básico)
- 🛡️ **Cisco Networking Academy:** Introduction to Cybersecurity | Computer Hardware Basics | Python Essentials 1
- 🔒 **Fundação Bradesco:** Segurança em Tecnologia da Informação
- 🌐 **Intelbras:** Introdução a Redes de Computadores
- 📈 **Gestão & Metodologias:** OKR Beginner (Profit) | Introdução ao Lean (FM2S)
